...
{
	public MorseEncodeCommand(Command parent)
	{
		super(parent, "encode", "Encodes text into morse.", "[text]");
	...
	public void run(@NotNull List<String> args, @NotNull CommandEvent event, @NotNull Consumer<CommandException> failure)
	{
		...
		{
			int index = MorseCommand.ENGLISH.indexOf(character);
			...
			builder.append(MorseCommand.MORSE.get(index)).append(" ");
		}
		...
		if (!isValid)
		{
			event.replyError("Some of your characters could not be encoded, there may be issues when decoding!");
		}
	}
}
