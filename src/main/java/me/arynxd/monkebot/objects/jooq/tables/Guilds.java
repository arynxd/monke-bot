...
import me.arynxd.monkebot.objects.jooq.tables.records.GuildsRecord;
...
public class Guilds extends TableImpl<GuildsRecord>
{
	 ...
	 */
	public final TableField<GuildsRecord, String> PREFERED_LANGUAGE = createField(DSL.name("prefered_language"), SQLDataType.VARCHAR(10).nullable(false).defaultValue(DSL.field("'en_US'::character varying", SQLDataType.VARCHAR)), this, "");
	/**
